...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s csscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  csscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded csscoin transaction") + "\n" +
              "  csscoin-tx [options] -create [commands]   " + _("Create hex-encoded csscoin transaction") + "\n" +
              "\n";
